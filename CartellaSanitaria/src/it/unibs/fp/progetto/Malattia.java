...
public class Malattia  implements Serializable{
	 ...
	 * @return elencoEsamiAssociati gli esami per cui la malattia pu� essere richiesta
	 */
	 ...
	 * @param sintomi i sintomi 
	 * @param diagnosi la diagnosi
	 * @param elencoEsamiAssociati l'elenco di esami che � possibile richiedere per questa malattia
	 * @param terapia la terapia
	 */
	...
	//metodi	
	/**
	 * Metodo che, dato il nome di un esame, permette di sapere se questo � presente nella lista di esami associati ad una malattia
	 * 
	 * @param nomeEsame il nome dell'esame da cercare
	 * @return true se l'esame � presente nell'elenco di esami associati, false altrimenti
	 */
